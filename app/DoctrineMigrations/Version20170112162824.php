...
class Version20170112162824 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE zizoo_cmsbundle_map_route_location (id BIGINT AUTO_INCREMENT NOT NULL, region_id BIGINT NOT NULL, map_pp_id BIGINT NOT NULL, INDEX IDX_8AD98F6B98260155 (region_id), INDEX IDX_8AD98F6B4D39E400 (map_pp_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE zizoo_cmsbundle_featured_partner (id BIGINT AUTO_INCREMENT NOT NULL, logo_id BIGINT NOT NULL, featured_partners_pp_id BIGINT NOT NULL, INDEX IDX_B6E64D33F98F144A (logo_id), INDEX IDX_B6E64D337589144A (featured_partners_pp_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
